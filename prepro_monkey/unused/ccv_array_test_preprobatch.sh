...
#SBATCH -J td_prepro_monkbatch_test
...
cd $PATH_TMP_SCRIPTS
matlab-threaded -nodisplay -r "td_prepro_realignbatch('$PATH_TMP', '$PATH_TMP_SESS'), exit"
...
rsync -az $PATH_TMP_SUBJECTS/$SESS/ $PATH_OUT
...
matlab-threaded -nodisplay -r "update_paths_v01('$SESS','$PATH_TMP'), exit"
