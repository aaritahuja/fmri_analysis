...
cd $PATH_TMP_SCRIPTS
matlab-threaded -nodisplay -r "td_prepro_rmsbatch($SLURM_ARRAY_TASK_ID, '$PATH_TMP', '$PATH_TMP_SUBJECTS'), exit"
...
matlab-threaded -nodisplay -r "rms_updatepaths_prepro_v01($SLURM_ARRAY_TASK_ID,'$PATH_TMP'), exit"
