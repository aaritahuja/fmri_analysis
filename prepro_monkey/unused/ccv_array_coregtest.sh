...
export PATH_OUT=/gpfs/data/tdesroch/monkey/walt/$SESS/bold/
...
cd $PATH_TMP_SCRIPTS
# matlab-threaded -nodisplay -r "td_prepro_coregbatch('$PATH_TMP', '$PATH_TMP_SESS'), exit"
...
rsync -az $PATH_TMP_SESS/ $PATH_OUT
